...
try:
    ...
    img_size = 128
    num_channels = 3
    train_path=r'C:/Users/tania/Desktop/Image_Classification_Tania_Chauhan/Using Tensorflow/data/train'
    ...
    def train(num_iteration):
        ...
        for i in range(total_iterations,
            ...
            if i % int(data.train.num_examples/batch_size) == 0: 
                ...
                saver.save(session, 'C:\\Users\\tania\\Desktop\\Image_Classification_Tania_Chauhan\\Using Tensorflow\\models\\trained_model') 
